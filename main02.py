...
''' 
n = 5
for i in range(n):  # 'range' - цикл добавлений
                    # 'n' - число повторов  
...
number_first = 4
number_second = 5
if number_first > number_second: # Ошибка!!! <- Отсутствие двоеточия (':') после цикла
    print(number_first)
...
if number_first > number_second:
    print(number_first) # Ошибка!!! <- Отсутствие отступов
...
'''
dictionary = {1: 'Monday', 2: 'Tuesday'} # Исправление ошибки
                                         # 1) меняем ключ на существующий (1 или 2)
                                         # 2) вводим ещё одно значение с ключом "3"
...
text = 'Python' # слово 'Python' следует заменить набором чисел ('555')
                # тогда 'text' будет выведен в виде числа ('555')

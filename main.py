...
"""
n1 = "<class 'str'> (тип данных: строка)" # выделяется в коде 
                                          # апострофом или кавычками
print(n1) 
...
print('Input first number') # Приглашение ко вводу данных
                            # При использовании "print" для строки 
                            # приглашения ко вводу,
                            # последующий ввод осуществляется 
                            # под строкой приглашения
a = input() # ввод строки
a = int(input()) # ввод числа 
                 # "a" - переменная, принимающая значение, 
                 # введённое в "input()"
...
c = int(c)
print(c)
print(type(c))  # <class 'int'> (тип данных: "целое число") -> 
                # убирает дробную часть числа

c = str(c)
print(c + '2')  # <class 'str'> (тип данных: "строка") -> 4 и 2 -> 42
                # тип 'str' допускает добавление новых записей, 
                # которые строка складывает вместе
print(type(c))

c = bool(c) # <class 'bool'> (логический тип данных) 
            # -> "True" (верно), "Falce" (ложно)
print(c)
print(type(c)) 
...
print(round(a*b, 3)) # "round" - оператор округления
                     # первая переменная в скобках - это 
                     # число, которое надо округлить
                     # вторая переменная - это  
...
while flag:
    if n % i == 0: # "n" кратно "i"
        flag = False
        print(i) # выводим "i", т.к. текущее значение "i"  
                 # - это минимальный делитель числа "n"
    elif i > n // 2: # значение делителя ("i") больше половины делимого ("n")
        print(n) # выводим значение "n", 
                 # если, не выполнено первое условие "n" кратно "i" 
                 # после перебора всех значений "i",
                 # либо "i" больше половины "n", т.е. 
                 # "n" не делится нацело на "i"
        flag = False

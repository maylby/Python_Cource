...
data = [1, 2, 3, 5, 8, 15, 23, 38]  # начальный список
res = map(int, data) # переменной 'res' передаём '=' начальный список (data),
                        # в виде целочисленных (int) значений (x)
print(res) # [1, 2, 3, 5, 8, 15, 23, 38] - начальный список

res = filter(lambda x: x % 2 == 0, res) # поиск только чётных значений (x)
print(res) # [2, 8, 38] - список чётных значений (x)

res = list(map(lambda x: (x, x**2), res)) # передаём 'res' cформированый список кортежей 
                                             # из значений (x), отобранных функцией where(),  
                                             # и квадратов (x**2) этих значений (x) 
print(res) # [(2, 4), (8, 64), (38, 1444)] - итоговый список (x, x**2)
